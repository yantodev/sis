<div class="container">
    <table class="table table-striped table-inverse table-responsive">
        <thead class="thead-inverse">
            <tr>
                <th><?= $data['nis']; ?> | <?= $data['nama_siswa']; ?></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td width="250px">Bidang Pekerjaan</td>
            </tr>
            <tr>
                <td><?= $data['bidang_pekerjaan']; ?></td>
            </tr>
            <tr>
                <td>Standar Keterampilan</td>
            </tr>
            <tr>
                <td><?= $data['sub_1']; ?></td>
            </tr>
...
<div class="mt-5" style="align-content: center;">
    <a href="<?= base_url('siswa/laporan/') . $data['nis']; ?>"><button class="btn btn-primary">Kembali</button></a>
    <h3 align="center"></h3>
</div>
...
<script>
    ...
    saveButton.addEventListener("click", function(event) {
        ...
        if (signaturePad.isEmpty()) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>siswa/insert_signature",
                data: {
