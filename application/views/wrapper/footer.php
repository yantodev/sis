     ...
     <footer class="sticky-footer bg-white">
         <div class="container my-auto">
             <div class="copyright text-center my-auto">
                 <span>Copyright &copy; IT Development <a href="https://smkmuhkarangmojo.sch.id/">SMK Muhammadiyah
                         Karangmojo</a> <?= date('Y'); ?>.<br />Versi 3.0 Powered By <a
                         href="https://yantodev.github.io">YantoDev</a></span>
             </div>
         </div>
     </footer>
     <!-- End of Footer -->
