...
class Tkro extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('tkro/index', $data);
    ...
    public function editProfile()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('wrapper/sidebar', $data);
            $this->load->view('wrapper/topbar', $data);
            $this->load->view('tkro/edit-profile', $data);
            $this->load->view('wrapper/footer');
        } else {
    ...
    public function IDCard($nis)
    {
        ...
        $this->load->view('wrapper/sidebar', $data);
        $this->load->view('wrapper/topbar', $data);
        $this->load->view('tkro/id-card', $data);
        $this->load->view('wrapper/footer');
        ...
        $html = $this->load->view('tkro/id-card', [], true);
        $mpdf->WriteHTML($html);
    ...
    public function editdata($nis)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('wrapper/sidebar', $data);
            $this->load->view('wrapper/topbar', $data);
            $this->load->view('tkro/edit-data', $data);
            $this->load->view('wrapper/footer');
        } else {
            $data = [
                'name' => $this->input->post('name'),
